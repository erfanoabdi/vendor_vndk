...
7z x -y $thispath/11/com.android.vndk.v28.apex.7z -o$systempath/system_ext/apex/ 2>/dev/null >> "$TMPDIR"/zip.log
7z x -y $thispath/11/com.android.vndk.v29.apex.7z -o$systempath/system_ext/apex/ 2>/dev/null >> "$TMPDIR"/zip.log
